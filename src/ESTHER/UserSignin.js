  ...
  return (
    <>
      ...
      <Fade when={toggle} right>
        <Div>
          <MobileNav onChange={onChange} onChanges={onChanges} />
        </Div>
      </Fade>
      {toggle ? (
        <Container p>
            ...
            <Wrapper>
              <Card1>
                <InnerCard1>
                  ...
                  <Line></Line>
                  <Text>
                    Welcome<span>Sign in to your company's platform</span>
                  </Text>
                  <Text2>
                    Don't have an account?
                    <span onClick={onChanges}>Sign up</span>
                  </Text2>
                </InnerCard1>
              </Card1>
                ...
                {image === "" ? (
                  <InnerCard1>
                    ...
                    <Text2>
                      ...
                      <span onClick={onChanges}>Sign in</span>
                    </Text2>
                  </InnerCard1>
                ) : (
                  <Display src={image} />
